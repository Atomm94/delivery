...
export class Migrations1750707395597 implements MigrationInterface {
    name = 'Migrations1750707395597'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_tokens_role_enum" AS ENUM('courier', 'company', 'customer')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."user_tokens_role_enum"`);
    }
