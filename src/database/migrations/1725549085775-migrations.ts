...
export class Migrations1725549085775 implements MigrationInterface {
    name = 'Migrations1725549085775'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Driver" ("id" SERIAL NOT NULL, "phone_number" character varying NOT NULL, "password" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying, "social_number" character varying, "license" character varying, "identity" character varying, "op_state" character varying, "op_cities" text, "isVerified" boolean NOT NULL DEFAULT false, "role" "public"."Driver_role_enum" NOT NULL DEFAULT 'courier', CONSTRAINT "UQ_6b49f11bf0cac3874e8959dc01f" UNIQUE ("phone_number"), CONSTRAINT "PK_9b78eddc1b0c643ec4e956eaac5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Truck" ("id" SERIAL NOT NULL, "mark" character varying NOT NULL, "model" character varying NOT NULL, "year" character varying NOT NULL, "vin_code" character varying NOT NULL, "license_plate_number" character varying NOT NULL, "max_capacity" integer NOT NULL, "length" integer NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "type" character varying NOT NULL, "condition" "public"."Truck_condition_enum" NOT NULL, "vehicle_title" text NOT NULL, "insurances" text NOT NULL, "photos" text NOT NULL, "porter" boolean NOT NULL DEFAULT false, "second_porter" boolean NOT NULL DEFAULT false, "third_porter" boolean NOT NULL DEFAULT false, "emergency_driver" boolean NOT NULL DEFAULT false, "driverId" integer, "companyId" integer, CONSTRAINT "PK_10d8b7678c66c21bf3438e203dc" PRIMARY KEY ("id"))`);
