...
export class Migrations1725462055615 implements MigrationInterface {
    name = 'Migrations1725462055615'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."Customer_role_enum" AS ENUM('courier', 'company', 'customer')`);
        await queryRunner.query(`CREATE TABLE "Customer" ("id" SERIAL NOT NULL, "person_name" character varying, "person_phone_number" character varying NOT NULL, "person_email" character varying, "password" character varying NOT NULL, "name" character varying, "email" character varying, "ITN" character varying, "phone_number" character varying, "owner" character varying, "owner_social_number" character varying, "address" character varying, "city" character varying, "state" character varying, "zip_code" integer, "addresses" json array, "docs" text array, "isVerified" boolean NOT NULL DEFAULT false, "role" "public"."Customer_role_enum" NOT NULL DEFAULT 'customer', CONSTRAINT "UQ_08026e21f73942a81b9db1d8044" UNIQUE ("person_phone_number"), CONSTRAINT "PK_60596e16740e1fa20dbf0154ec7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."Company_role_enum" AS ENUM('courier', 'company', 'customer')`);
        await queryRunner.query(`CREATE TABLE "Company" ("id" SERIAL NOT NULL, "phone_number" character varying NOT NULL, "name" character varying NOT NULL, "license" text array, "isVerified" boolean NOT NULL DEFAULT false, "role" "public"."Company_role_enum" NOT NULL DEFAULT 'company', CONSTRAINT "UQ_5d31fb90bee42a41ec5467a055d" UNIQUE ("phone_number"), CONSTRAINT "PK_b4993a6b3d3194767a59698298f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."Truck_condition_enum" AS ENUM('normal', 'good', 'fine')`);
        await queryRunner.query(`CREATE TABLE "Truck" ("id" SERIAL NOT NULL, "mark" character varying NOT NULL, "model" character varying NOT NULL, "year" character varying NOT NULL, "vin_code" character varying NOT NULL, "license_plate_number" character varying NOT NULL, "max_capacity" integer NOT NULL, "length" integer NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "type" character varying NOT NULL, "condition" "public"."Truck_condition_enum" NOT NULL, "vehicle_title" text array NOT NULL, "insurances" text array NOT NULL, "photos" text array NOT NULL, "porter" boolean NOT NULL DEFAULT false, "second_porter" boolean NOT NULL DEFAULT false, "third_porter" boolean NOT NULL DEFAULT false, "emergency_driver" boolean NOT NULL DEFAULT false, "driverId" integer, "companyId" integer, CONSTRAINT "PK_10d8b7678c66c21bf3438e203dc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."Driver_role_enum" AS ENUM('courier', 'company', 'customer')`);
        await queryRunner.query(`CREATE TABLE "Driver" ("id" SERIAL NOT NULL, "phone_number" character varying NOT NULL, "password" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying, "social_number" character varying, "license" character varying, "identity" character varying, "op_state" character varying, "op_cities" text array, "isVerified" boolean NOT NULL DEFAULT false, "role" "public"."Driver_role_enum" NOT NULL DEFAULT 'courier', CONSTRAINT "UQ_6b49f11bf0cac3874e8959dc01f" UNIQUE ("phone_number"), CONSTRAINT "PK_9b78eddc1b0c643ec4e956eaac5" PRIMARY KEY ("id"))`);
