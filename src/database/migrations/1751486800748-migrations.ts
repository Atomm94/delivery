...
export class Migrations1751486800748 implements MigrationInterface {
    name = 'Migrations1751486800748'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rate" ("id" SERIAL NOT NULL, "star" double precision NOT NULL, "type" character varying NOT NULL, "feedback" text NOT NULL, "driverId" integer, "customerId" integer, CONSTRAINT "PK_2618d0d38af322d152ccc328f33" PRIMARY KEY ("id"))`);
