...
export class Migrations1737673292020 implements MigrationInterface {
    name = 'Migrations1737673292020'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "route" ("id" SERIAL NOT NULL, "start_time" TIMESTAMP WITH TIME ZONE, "car_type" character varying, "porter" character varying NOT NULL DEFAULT 'Without porter', "payment" "public"."route_payment_enum" NOT NULL DEFAULT 'not_payed', "status" "public"."route_status_enum" NOT NULL DEFAULT 'incoming', "price" double precision, "invoiceId" integer, "loadAddresses" integer array, "customerId" integer, "truckId" integer, CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`);
